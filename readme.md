...
| 🟡 Средний | Бухгалтерия и отчетность | Выгрузка в 1С, финансовые отчеты, налоговые расчеты |
...
- [ ] Генерация ведомостей и выгрузка в 1С / бухгалтерию
...
- [ ] Выгрузка проводок и контрагентов в формате 1С
- [ ] Двусторонняя синхронизация справочников (по необходимости)
- [ ] Настройка периодичности и правил синхронизации
...
| **Фаза 3** | • Расчет зарплаты <2с на 50 преподавателей • Интеграция с 1С стабильна | • Экономия 10+ часов/мес на расчете зарплат • Удержание преподавателей +15% |
